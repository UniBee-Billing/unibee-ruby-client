...
module Unibee
  # Get invoice list
  class UnibeeApiMerchantInvoiceListReq
    # The filter end amount of invoice
    attr_accessor :amount_end

    # The filter start amount of invoice
    attr_accessor :amount_start
    ...
    attr_accessor :report_time_end

    # ReportTimeStart，UTC timestamp，seconds
    attr_accessor :report_time_start
    ...
    def self.attribute_map
      {
        ...
        :'last_name' => :'lastName',
        :'page' => :'page',
        :'report_time_end' => :'reportTimeEnd',
        :'report_time_start' => :'reportTimeStart',
    ...
    def self.openapi_types
      {
        ...
        :'currency' => :'String',
        :'delete_include' => :'Boolean',
        :'first_name' => :'String',
        :'gateway_ids' => :'Array<Integer>',
        :'last_name' => :'String',
        :'page' => :'Integer',
        :'report_time_end' => :'Integer',
        :'report_time_start' => :'Integer',
        :'search_key' => :'String',
        :'send_email' => :'String',
        :'sort_field' => :'String',
        :'sort_type' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Unibee::UnibeeApiMerchantInvoiceListReq` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Unibee::UnibeeApiMerchantInvoiceListReq`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'amount_end')
        self.amount_end = attributes[:'amount_end']
      end

      if attributes.key?(:'amount_start')
        self.amount_start = attributes[:'amount_start']
      end
      ...
      if attributes.key?(:'delete_include')
        self.delete_include = attributes[:'delete_include']
      end
      ...
      if attributes.key?(:'gateway_ids')
        if (value = attributes[:'gateway_ids']).is_a?(Array)
          self.gateway_ids = value
        end
      end
      ...
      if attributes.key?(:'report_time_end')
        self.report_time_end = attributes[:'report_time_end']
      end

      if attributes.key?(:'report_time_start')
        self.report_time_start = attributes[:'report_time_start']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amount_end == o.amount_end &&
          amount_start == o.amount_start &&
          count == o.count &&
          create_time_end == o.create_time_end &&
          create_time_start == o.create_time_start &&
          currency == o.currency &&
          delete_include == o.delete_include &&
          first_name == o.first_name &&
          gateway_ids == o.gateway_ids &&
          last_name == o.last_name &&
          page == o.page &&
          report_time_end == o.report_time_end &&
          report_time_start == o.report_time_start &&
    ...
    def hash
      [amount_end, amount_start, count, create_time_end, create_time_start, currency, delete_include, first_name, gateway_ids, last_name, page, report_time_end, report_time_start, search_key, send_email, sort_field, sort_type, status, type, user_id].hash
    end
