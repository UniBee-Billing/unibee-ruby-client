...
module Unibee
  class UnibeeApiMerchantInvoiceNewReq
    ...
    def self.openapi_types
      {
        ...
        :'finish' => :'Boolean',
        :'gateway_id' => :'Integer',
        :'lines' => :'Array<UnibeeApiMerchantInvoiceNewInvoiceItemParam>',
        :'name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Unibee::UnibeeApiMerchantInvoiceNewReq` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Unibee::UnibeeApiMerchantInvoiceNewReq`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @tax_percentage.nil?
        invalid_properties.push('invalid value for "tax_percentage", tax_percentage cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tax_percentage.nil?
    ...
    def hash
      [currency, tax_percentage, user_id, apply_promo_credit, apply_promo_credit_amount, finish, gateway_id, lines, name].hash
    end
