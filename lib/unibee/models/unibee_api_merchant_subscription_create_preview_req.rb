...
module Unibee
  class UnibeeApiMerchantSubscriptionCreatePreviewReq
    # PlanId
    ...
    attr_accessor :free_in_initial_period
    ...
    def self.attribute_map
      {
        ...
        :'free_in_initial_period' => :'freeInInitialPeriod',
    ...
    def self.openapi_types
      {
        ...
        :'free_in_initial_period' => :'Boolean',
        :'gateway_id' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Unibee::UnibeeApiMerchantSubscriptionCreatePreviewReq` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Unibee::UnibeeApiMerchantSubscriptionCreatePreviewReq`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'free_in_initial_period')
        self.free_in_initial_period = attributes[:'free_in_initial_period']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          free_in_initial_period == o.free_in_initial_period &&
    ...
    def hash
      [plan_id, addon_params, apply_promo_credit, apply_promo_credit_amount, currency, discount_code, email, external_user_id, free_in_initial_period, gateway_id, gateway_payment_type, quantity, tax_percentage, trial_end, user, user_id, vat_country_code, vat_number].hash
    end
