...
module Unibee
  class UnibeeApiBeanCreditConfig
    # create utc time
    ...
    attr_accessor :total_decrement_amount

    # the total increment amount
    attr_accessor :total_increment_amount
    ...
    def self.attribute_map
      {
        ...
        :'recurring' => :'recurring',
        :'total_decrement_amount' => :'totalDecrementAmount',
    ...
    def self.openapi_types
      {
        ...
        :'recurring' => :'Integer',
        :'total_decrement_amount' => :'Integer',
        :'total_increment_amount' => :'Integer',
        :'type' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Unibee::UnibeeApiBeanCreditConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Unibee::UnibeeApiBeanCreditConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_decrement_amount')
        self.total_decrement_amount = attributes[:'total_decrement_amount']
      end

      if attributes.key?(:'total_increment_amount')
        self.total_increment_amount = attributes[:'total_increment_amount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_decrement_amount == o.total_decrement_amount &&
          total_increment_amount == o.total_increment_amount &&
          type == o.type
    end
    ...
    def hash
      [create_time, currency, description, discount_code_exclusive, exchange_rate, id, logo, logo_url, merchant_id, meta_data, name, payout_enable, preview_default_used, recharge_enable, recurring, total_decrement_amount, total_increment_amount, type].hash
    end
