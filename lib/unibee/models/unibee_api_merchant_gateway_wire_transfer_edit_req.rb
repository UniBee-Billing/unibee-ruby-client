...
module Unibee
  ...
  class UnibeeApiMerchantGatewayWireTransferEditReq
    ...
    def self.openapi_types
      {
        ...
        :'display_name' => :'String',
        :'gateway_icons' => :'Array<Array<String>>',
        :'sort' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Unibee::UnibeeApiMerchantGatewayWireTransferEditReq` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Unibee::UnibeeApiMerchantGatewayWireTransferEditReq`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @minimum_amount.nil?
        invalid_properties.push('invalid value for "minimum_amount", minimum_amount cannot be nil.')
      end
    ...
    def hash
      [currency, gateway_id, minimum_amount, bank, display_name, gateway_icons, sort].hash
    end
