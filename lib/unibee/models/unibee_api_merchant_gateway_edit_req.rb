...
module Unibee
  ...
  class UnibeeApiMerchantGatewayEditReq
    ...
    def self.openapi_types
      {
        ...
        :'display_name' => :'String',
        :'gateway_key' => :'String',
        :'gateway_logo' => :'Array<Array<String>>',
        :'gateway_payment_types' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Unibee::UnibeeApiMerchantGatewayEditReq` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Unibee::UnibeeApiMerchantGatewayEditReq`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'gateway_logo')
        if (value = attributes[:'gateway_logo']).is_a?(Array)
          self.gateway_logo = value
        end
      end
    ...
    def hash
      [gateway_id, company_issuer, currency_exchange, display_name, gateway_key, gateway_logo, gateway_payment_types, gateway_secret, metadata, sort, sub_gateway].hash
    end
