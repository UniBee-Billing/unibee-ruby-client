# Unibee::UnibeeApiMerchantCreditNewConfigReq
...
| **exchange_rate** | **Integer** | keep two decimal places，scale &#x3D; 100, 1 currency &#x3D; 1 credit * (exchange_rate/100), no effect on main account type | [optional] |
...
| **payout_enable** | **Integer** | credit account can used or payout in purchase or not, 0-no, 1-yes | [optional] |
| **preview_default_used** | **Integer** | is default used when in purchase preview, default no, 0-no, 1-yes | [optional] |
| **recharge_enable** | **Integer** | credit account can be recharged or not, 0-no, 1-yes | [optional] |
...
instance = Unibee::UnibeeApiMerchantCreditNewConfigReq.new(
  currency: null,
  type: null,
  description: null,
