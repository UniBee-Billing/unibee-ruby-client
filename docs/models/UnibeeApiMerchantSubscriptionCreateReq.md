# Unibee::UnibeeApiMerchantSubscriptionCreateReq
...
| **cancel_url** | **String** | CancelUrl, back to cancelUrl if creation cancelled | [optional] |
...
| **free_in_initial_period** | **Boolean** | Is free or not for the first period, true or false, high priority higher then trialEnd | [optional] |
...
| **return_url** | **String** | ReturnUrl, back to returnUrl if creation completed | [optional] |
...
instance = Unibee::UnibeeApiMerchantSubscriptionCreateReq.new(
  plan_id: null,
  addon_params: null,
